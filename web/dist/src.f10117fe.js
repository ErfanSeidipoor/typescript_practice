...
function () {
  ...
  _createClass(View, [{
    ...
    value: function bindEventHandler(fragment) {
      var eventsMap = this.eventsMap();

      var _loop = function _loop(keyEventSelector) {
        var _keyEventSelector$spl = keyEventSelector.split(':'),
            _keyEventSelector$spl2 = _slicedToArray(_keyEventSelector$spl, 2),
            event = _keyEventSelector$spl2[0],
            selector = _keyEventSelector$spl2[1];
      ...
      for (var keyEventSelector in eventsMap) {
        _loop(keyEventSelector);
      }
    }
  }, {
    key: "onRender",
...
function (_View_1$View) {
  ...
  function UserForm(parent, model) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UserForm).call(this, parent, model));
    _this.parent = parent;
    ...
    _this.onSetNameClick = function () {
      var input = _this.parent.querySelector('.input-name');
...
},{"./View":"src/views/View.ts"}],"src/views/UserView.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_View_1$View) {
  _inherits(UserView, _View_1$View);
...
function (_View_1$View) {
  ...
  _createClass(UserEdit, [{
    ...
    value: function onRender() {
      ...
      new UserView_1.UserView(this.regions["userShow"], this.model).render();
    }
  }, {
    key: "template",
    value: function template() {
...
},{"./View":"src/views/View.ts","./UserForm":"src/views/UserForm.ts","./UserView":"src/views/UserView.ts"}],"src/models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
},{"./../utils":"node_modules/axios/lib/utils.js","./../core/settle":"node_modules/axios/lib/core/settle.js","./../helpers/buildURL":"node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"node_modules/axios/lib/core/createError.js","./../helpers/cookies":"node_modules/axios/lib/helpers/cookies.js"}],"C:/Users/erfan/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/erfan/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
var Sync = function Sync(rootUrl) {
  ...
  this.save = function (data) {
    var id = data.id;
    if (id) return axios_1.default.put("".concat(_this.rootUrl, "/").concat(id), data);
...
exports.Attributes = Attributes; // class Color {
//   color = 'red'
//   // constructor() {
...
function () {
  function Model(events, sync, attributes) {
    ...
    this.events = events;
    this.sync = sync;
    this.attributes = attributes; // on(eventName: string, callback: Callback):void {
    ...
    this.trigger = this.events.trigger; // another for accessor this line is exequted at the first line of constructor
  }
...
/*#__PURE__*/
function () {
  function Collection(rootUrl, deseialize) {
    _classCallCheck(this, Collection);

    this.rootUrl = rootUrl;
    this.deseialize = deseialize;
    this.models = [];
    ...
    value: function fetch() {
      ...
      axios_1.default.get(this.rootUrl).then(function (response) {
        response.data.forEach(function (data) {
          return _this.models.push(_this.deseialize(data));
        });
...
function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function from(data) {
      return new User(new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl), new Attributes_1.Attributes(data));
    }
  }, {
    key: "buildOther",
    value: function buildOther(data) {
      return new User(new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl), new Attributes_1.Attributes(data));
    }
  }, {
    key: "buildUserCollection",
    value: function buildUserCollection() {
      return new Collection_1.Collection(rootUrl, this.from);
    }
  }]);
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
  ...
  _createClass(CollectionView, [{
    ...
    value: function render() {
      ...
      this.collection.models.forEach(function (element) {
        ...
        _this.renderItem(element, itemParent);
...
var UserList =
/*#__PURE__*/
function (_CollectionView_1$Col) {
  ...
  _createClass(UserList, [{
    ...
    value: function renderItem(model, itemParent) {
      new UserView_1.UserView(itemParent, model).render();
    }
  }]);
...
},{"./CollectionView":"src/views/CollectionView.ts","./UserView":"src/views/UserView.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var users = new Collection_1.Collection('http://localhost:3000/users', function (data) {
  return User_1.User.from(data);
});
users.fetch();
users.on('fetch', function () {
  console.log(users);
  new UserList_1.UserList(document.getElementById('root1'), users).render();
});
},{"./views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts"}],"C:/Users/erfan/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/erfan/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
